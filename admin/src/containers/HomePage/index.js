...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/React-avacado',
  },
  {
    name: 'Twitter',
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>Ao lado voce pode inserir diferentes jogos categorias e publishers para a nossa
              maravilhosa loja de jogos!</P>
          ...
          <div className="col-md-12 col-lg-4">
            ...
            <P style={{ marginTop: 7, marginBottom: 0 }}>Em caso de duvidas ou sugestões, so ir em algum de nossos links =)</P>
            <ALink
              rel="noopener noreferrer"
              href="https://brennoprimeirosite.netlify.app/"
              target="_blank"
              >
              Veja o nosso planejamento de modulos!
            </ALink>
